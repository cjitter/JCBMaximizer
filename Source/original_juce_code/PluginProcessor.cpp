...
//==============================================================================
const juce::String JCBMaximizerAudioProcessor::getName() const
{
...
bool JCBMaximizerAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool JCBMaximizerAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
